    ...
    <ContentFieldVue>
        <div class="game-table">
            <div>
                ...
                <button type="button"
                        style="float: right"
                        @click="show_add_modal_handler(true)">
                    创建Bot
                </button>
                ...
                <div class="game-modal"
                    ...
                    <div>
                        ...
                        <div>
                            ...
                            <textarea style="width: 85%; margin-top: 10px"
                    ...
                    <div>
                        ...
                        <button type="button"
                                @click="show_add_modal_handler(false)">取消</button>
                    </div>
                </div>
                <table>
                    <thead>
                        ...
                        <tr v-for="bot in bots"
                            ...
                            <td>
                                <button type="button"
                                        ...
                                        @click="show_update_modal_handler(bot.id, true)">修改</button>
                                <button type="button"
